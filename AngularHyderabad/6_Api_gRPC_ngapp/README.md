# Speaking Event - Web API, gRPC Web, using .NET 5, and Angular 12

> 1. Event Date: **28-May-2021**
> 1. Event URL: [Angular Virtual Conference](https://www.2020twenty.net/angular-virtual-conference-2021/)
...
> 1. Verify Web API which was developed using Layers. Testing using Postman
> 1. Verify gRPC which was developed using Layers. Testing using Windows Forms
> 1. Creating Angular 12 App, retrieving content from Web API, and gRPC Web.
> 1. Retrieving content from Web API, and gRPC Web 
> 1. Showcasing the Content Length and Time between API and gRPC Web.
> 1. Data Representation in Table View / Card Card.
