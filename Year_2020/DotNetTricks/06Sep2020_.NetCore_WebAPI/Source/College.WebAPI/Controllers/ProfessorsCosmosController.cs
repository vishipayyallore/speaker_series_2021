...
namespace College.WebAPI.Controllers
{
    ...
    [ApiController]
    public class ProfessorsCosmosController : ControllerBase
    {

        private readonly ILogger<ProfessorsCosmosController> _logger;
        private readonly IProfessorsCosmosBll _professorsCosmosBll;

        public ProfessorsCosmosController(ILogger<ProfessorsCosmosController> logger, IProfessorsCosmosBll professorsCosmosBll)
        {
            _logger = logger;
