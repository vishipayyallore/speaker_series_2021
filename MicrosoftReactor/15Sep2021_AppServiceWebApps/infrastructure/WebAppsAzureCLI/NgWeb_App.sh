...
git remote add azure https://$USERNAME@app-azsxdcfv2.scm.azurewebsites.net/app-azsxdcfv.git
...
git clone https://$USERNAME@app-azsxdcfv.scm.azurewebsites.net/app-azsxdcfv.git
git remote add azure https://$USERNAME@app-azsxdcfv.scm.azurewebsites.net/app-azsxdcfv.git
