namespace College.Core.Common
{
    ...
    public static class Constants
    {
        ...
        {
            public static string[] Consonants { get; } = { "b", "c", "d", "f", "g", "h", "j", "k", "l", "m", "l", "n", "p", "q", "r", "s", "sh", "zh", "t", "v", "w", "x" };

            public static string[] Vowels { get; } = { "a", "e", "i", "o", "u", "ae", "y" };
        }

        public static class GenerateAddress
        {
            public static string FullAddress { get; } = "Flat Number: {0}, {1} Apartments, Street: {2}, Hyderabad.";
        }

        public static class AddressConstants
        {
            public static string[] EnrollmentTypes { get; } = { "Internal Exams", "Lab Session", "Library Usage", "External Exams" };
        }
